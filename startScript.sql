...
values ('Филе куриной грудки', '', 1.9, 23.6, 0.4, 113, 11,2,2),
       ('Сливочное масло', '', 72.5, 0.8, 1.3, 661, 11,2,1),
       ('Куриное яйцо', '', 11, 13, 1.1, 155, 11,1,3),
       ('Пшеничная мука', '', 1, 10, 76, 364, 11,2,2),
       ('Петрушка', '', 0.8, 3, 6, 36, 11,1,3),
       ('Панировочные сухари', '', 1.9, 9.7, 77.6, 347, 11,2,1),
       ('Подсолнечное масло', '', 99.9, 0, 0, 899, 11, 4,2);